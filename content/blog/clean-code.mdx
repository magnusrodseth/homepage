...
<Image
    src="/img/blog/clean-code/emergence.jpg"
    caption="Just like a caterpillar emerges into a butterfly, 
    we incrementally improve upon our code into something beautiful."
    />

This chapter is largely spent on tying previous information together to form the
main point of this chapter: **Follow all above-mentioned rules in order to
achieve a good system design**.

## 13 - Concurrency

<Image
    src="/img/blog/clean-code/concurrency.jpeg"
    caption="Concurrency and parallelism are two different things."
    />

There is quite a lot to dig into here. Because I am (1) not familiar with
concurrency at all and (2) currently working on things not primarily related to
concurrency, I'll hold off on writing notes for this chapter. Rather, I will
revisit this chapter later down the road when I'm in more need of understanding
the details of concurrency.

**TODO: Write notes about concurrency**.

## 14 - Successive Refinement

This chapter is about Martin making an argument parser for the console using
Java. He calls the application `Args`. This part is best read from the book, as
it really is a case study of how to refactor code whilst keeping tests passing.
Hence, I'll not include notes for this chapter.

## 15 - JUnit Internals

The same goes for this chapter. Martin spends a chapter reviewing implementation
detail in th JUnit test framework for Java, and how it can be improved. This is
also best experienced simply reading the book, not by reading my notes.

## 16 - Refactoring SerialDate

Let me include a brief quote from the beginning of this chapter, as I think it
helps drive the point of this chapter home:

> The author of `SerialDate` is David Gilbert. David is clearly an experienced
> and competent programmer. [...] For all intents and purposes, [`SerialDate`]
> is "good code". **And I am going to rip it to pieces**.

Martin goes on to say the following, and I think this is the essence of this
chapter:

> This is not an activity of malice. Nor do I think I am so much better than
> David that I somehow have a right to pass judgement on his code. Indeed, if
> you were to find some of my code, I'm sure you could find plenty of things to
> complain about. [...] **What I am about to do is nothing more or nothing less
> than a professional review. It is something we should all be comfortable
> doing**.

Doctors do it. Pilots do it. Lawyers do it. **Programmers need to learn to do it
too**.

## 17 - Smells and Heuristics

**TODO: Write down these tips and tricks. They carry the essence of the entire
book**.
